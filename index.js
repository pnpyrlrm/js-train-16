...
function compareArrays(arr1, arr2) {
  ...
  console.assert(isEqual, "Масиви не однакові!");
}
...
function displayGroupedInfo(students) {
  ...
  for (let i of students) {
    ...
    console.info(`Вік: ${i.age}`);
    console.info(`Предмет: ${i.subject}`);
    console.groupEnd();
  }
}
...
function validateUserInput(userInput) {
  ...
  console.assert(
    userInput.username,
    console.info("Помилка: ім'я користувача відсутнє!")
  );
  console.assert(
    userInput.password,
    console.info("Помилка: пароль відсутній!")
  );
  console.assert(
    userInput.length < 8,
    console.info("Попередження: пароль має бути довшим за 8 символів!")
  );
}
...
function countVowelsAndConsonants(word) {
  ...
  for (let letter of result) {
    ...
    if (str.includes(lowerCaseLetter)) {
      console.count("Кількість голосних");
    } else {
      console.count("Кількість приголосних");
    }
  }
  console.countReset("Кількість голосних");
  console.countReset("Кількість приголосних");
}
